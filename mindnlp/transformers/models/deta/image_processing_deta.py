...
from ...image_processing_utils import BatchFeature,BaseImageProcessor, get_size_dict
...
from mindnlp.utils import ExplicitEnum, TensorType
...
class DetaImageProcessor(BaseImageProcessor):
    ...
    def post_process_object_detection(
        ...
        all_scores = prob.view(batch_size, num_queries * num_labels)
        all_indexes = torch.arange(num_queries * num_labels)[None].repeat(batch_size, 1)
